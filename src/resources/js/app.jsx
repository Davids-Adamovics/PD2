...
export default function App() {
    ...
    function handleSelectedBooks(id) {
        setSelectedBook(id);
    }
    ...
    return (
        <>
            {selectedBook ? 
            <BookPage selectedBook={selectedBook} onSelect={handleSelectedBooks} />
            : <Homepage onSelect={handleSelectedBooks} />}
        </>
    );
}
    ...
    return (
        <div className="row mb-5 pt-5 pb-5 bg-light">
            <div className={`col-md-6 mt-2 px-5 ${book.idx % 2 === 0 ? 'text-start order-2' : 'text-end order-1'}`}>
                ...
                <p className="lead">
                    {book.description ? book.description.split(' ').slice(0, 32).join(' ') + '...' : ''}
                </p>
                ...
                <div className="row mb-5">
                    <div className="col-md-6 pt-5">
                        ...
                        <dl className="row">
                            ...
                            <dd className="col-sm-9">{bookData.category}</dd>
                        </dl>
...
function RelatedBook({ book, onSelect }) {
    return (
        <div className="col-md-4">
            <div className="card">
                <img className="card-img-top" src={book.image} alt={book.name} style={{ height: "300px" }} />
